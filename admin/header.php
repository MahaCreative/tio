...
<head>
	...
	<title>Super Admin - Sistem Pengaduan Layanan Rumah Sakit Mitra Manakarra</title>
...
<body>
	...
	<div class="bg-success" style="padding: 20px;text-align: center;">
		<h1>
			SISTEM PENGADUAN LAYANAN RUMAH SAKIT BERBASIS ONLINE
			<br>
			Rumah Sakit Mitra <b>Manakarra</b>
		</h1>
	</div>
			...
			<ul class="nav navbar-nav navbar-right">							
				...
				<li class="dropdown dropdown-user">
					<a class="dropdown-toggle" data-toggle="dropdown">
						<img src="" alt="">
						<span><?php echo $_SESSION['username']; ?> <b></b></span>
						<i class="caret"></i>
					</a>
