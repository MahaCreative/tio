					...
					<div class="panel-body">
						<div class="table-responsive">
							<form action="pengaduan_update.php" method="post">
								...
								<?php 
								$id = $_GET['id'];
								$data = mysqli_query($koneksi,"select * from pengaduan,pasien where pengaduan.id_pasien=pasien.pasien_id and pengaduan.id_pengaduan='$id'");
										...
										<tr>
											...
											<th>
												...
												<select class="form-control" name="status">													
													<option <?php if($d['status_pengaduan'] == "0"){echo "selected='selected'";} ?> value="0">Menunggu Konfirmasi</option>
													<option <?php if($d['status_pengaduan'] == "1"){echo "selected='selected'";} ?> value="1">Di Terima & Selesai</option>
												</select>												
											</th>
										</tr>
										<tr>
